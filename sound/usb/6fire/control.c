		...
		struct snd_ctl_elem_info *uinfo)
{
	...
	strlcpy(uinfo->value.enumerated.name,
			line_phono_texts[uinfo->value.enumerated.item], sizeof(uinfo->value.enumerated.name));
	return 0;
}
		...
		struct snd_ctl_elem_info *uinfo)
{
	...
	if (uinfo->value.enumerated.item > 1)
		uinfo->value.enumerated.item = 1;
	strlcpy(uinfo->value.enumerated.name,
			opt_coax_texts[uinfo->value.enumerated.item], sizeof(uinfo->value.enumerated.name));
	return 0;
}
